...
for digit in numbers:
    if digit == 0:
        ...
        c += 1
print(f"Zero occurrs {a} time")
print (f"Negative numbers occurred {b} times")
print (f"Positive numbers occurred {c} times")
...
for digit in numbers:
    if digit < 0:
        ...
        e += digit
print(f"Sum of negative numbers {d}")
print(f"Sum of positive numbers {e}")
